                ...
                <div class="card">
                    ...
                    ?>
                        <form action="login.php" method="post">
                            ...
                            <input type="submit" value="Login" class="btn btn-lg btn-info w-100 fs-6" name="submit">
                        </form>
                    </div>
                    <div class="text-center">
                        <p>Belum Punya Akun? <a href="daftar.php" class="link-danger fw-bold">Daftar, Sekarang!</a></p>
...
<!-- <div class="card-body text-center">
    <img src="assets/img/y.jpg" class="rounded-circle" height="150px" width="150px" alt="Gambar">
</div> -->